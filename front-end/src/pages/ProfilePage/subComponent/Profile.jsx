...
function BasicInfo(props) {
    const { theme, onClick, loading, ...other } = props;
    return (
        <Box
            sx={{
                padding: '30px 10px',
        ...
        >
            ...
            <Button
                ...
                sx={{
                    ...
                    position: 'relative', // Để đặt spinner ở giữa
                }}
                ...
                <Stack flexDirection={'row'}>
                    ...
                    <LocalizationProvider dateAdapter={AdapterDayjs}>
                        <DemoContainer components={['DatePicker']}>
                            <DatePicker value={dayjs()} label="Ngày sinh" />
                        </DemoContainer>
...
function Profile(props) {
    ...
    return (
        ...
        >
            ...
            <Divider />
            {updateInfo ? (
                <UpdateInfo theme={theme} loading={loading} onClick={handleButtonSetUpdate} />
            ) : (
                <BasicInfo theme={theme} loading={loading} onClick={handleButtonSetUpdate} />
            )}{' '}
        </Stack>
    );
}
