...
const StyledMenuItem = styled(MenuItem)({
    ...
    '&:hover': {
        paddingLeft: '20px',
        background: 'linear-gradient(90deg, hsla(0, 93%, 94%, 1), hsla(0, 93%, 94%, 0))',
...
const StyledListItemIcon = styled(ListItemIcon)({
    color: 'inherit', // Để màu icon kế thừa từ màu chữ
    '&:hover': {
        color: '#0000ff', // Màu icon khi hover
    },
});
                ...
                <Stack sx={{ gap: '10px' }}>
                    ...
                    >
                        ...
                        <Stack>
                            <Typography
                                variant="subtitle2"
                                sx={{ fontSize: '15px', lineHeight: 1.3, fontWeight: 6000 }}
                            >
                                Nguyễn Lê Tấn Đạt
                            </Typography>
                            <Typography
